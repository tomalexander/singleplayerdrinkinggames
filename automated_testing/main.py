...
def games_check():
    ...
    new_game = get_uuid()
    success_game = call_server("submit_game.php", {"game_name": new_game, "submitter_id": -1, "uuid": account_uuid, "short_description": "test short desc", "long_description": "test long desc", "supplies[]": "test", "instructions": "## Instructions"})
    ...
    fail_game = call_server("submit_game.php", {"game_name": new_game, "submitter_id": -1, "uuid": account_uuid, "short_description": "test short desc", "long_description": "test long desc", "supplies[]": "test", "instructions": "## Instructions"})
